    ...
    public byte[] transform(ClassLoader loader, String className, Class cBR,
        ...
        try {
            ClassParser cp = new ClassParser(new java.io.ByteArrayInputStream(
                    classfileBuffer), className + ".java"); //$NON-NLS-1$
...
//            System.err.println("Method " + methodName + " not found in " //$NON-NLS-1$ //$NON-NLS-2$
//                    + className);
//            System.exit(0);
    ...
    public static void premain(String options, Instrumentation ins) {
        if (options != null) {
            ...
            System.out
                    .println("Usage: java -javaagent:Timing.jar=\"class:method\""); //$NON-NLS-1$
            System.exit(0);
        }
